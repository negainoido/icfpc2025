    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ margin: '0 0 20px 0', color: '#343a40' }}>セッション履歴</h2>
              ...
              <table style={{
                ...
                <thead>
                  <tr style={{ backgroundColor: '#f8f9fa' }}>
                    ...
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '2px solid #dee2e6' }}>継続時間</th>
                    <th style={{ padding: '12px', textAlign: 'center', borderBottom: '2px solid #dee2e6' }}>アクション</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '20px' }}>
              <h3 style={{ color: '#343a40', marginBottom: '10px' }}>セッション情報</h3>
              <div style={{
                backgroundColor: '#f8f9fa',
                padding: '15px',
                borderRadius: '6px',
                ...
                <div><strong>ステータス:</strong> 
                  <span style={{
                    ...
                    fontWeight: 'bold',
                    color: 'white',
                    backgroundColor: getStatusBadgeColor(selectedSession.session.status),
                    marginLeft: '8px'
                  }}>
                    {selectedSession.session.status}
                  </span>
                </div>
                <div><strong>開始時刻:</strong> {formatDateTime(selectedSession.session.created_at)}</div>
                {selectedSession.session.completed_at && (
                  <div><strong>終了時刻:</strong> {formatDateTime(selectedSession.session.completed_at)}</div>
                )}
                <div><strong>継続時間:</strong> {getSessionDuration(selectedSession.session)}</div>
              </div>
            </div>
                      ...
                      <div style={{
                        ...
                        <div>
                          ...
                          <span style={{
                            marginLeft: '10px',
                            padding: '2px 6px',
                            backgroundColor: log.response_status === 200 ? '#28a745' : '#dc3545',
                            color: 'white',
                            borderRadius: '4px',
                            fontSize: '12px'
                          }}>
